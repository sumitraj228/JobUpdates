     ...
     const handleSubmit = async(e)=>{
      ...
      try {
        ...
        if(!res.ok){
          ...
          setUpdateUserSuccess("User's profile updated successully")
        }
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <div className=' relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidded rounded-full' onClick={()=>filePickerRef.current.click()}>
      ...
      <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
        ...
        <Modal.Body>
          <div className='text-center'>
            <HiOutlineExclamationCircle className='h-14 w-14 text-gray-400 dark:text-gary-200 mb-4 mx-auto'/>
